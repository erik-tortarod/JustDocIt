 ...
 * activity-related operations including creating and retrieving activities. All endpoints
...
public class ActivityController {
	 ...
	 * @param requestBody Map containing activity details: - description: The activity
	 * description - category: The activity category
	 * @return ResponseEntity containing the created activity or an error message
	 */
	@PostMapping
	 ...
	 * @param authHeader The Authorization header containing the JWT token
	 * @return ResponseEntity containing a list of activities or an error message
	 */
	@GetMapping
