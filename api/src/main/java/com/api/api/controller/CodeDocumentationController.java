...
/**
 * REST Controller for managing code documentation. This controller handles
 * operations related to scanning repositories for documentation, retrieving
 * documentation for repositories and specific files. Most endpoints require JWT
 * authentication.
 */
@RestController
...
public class CodeDocumentationController {
    ...
    /**
     * Scans a repository for documentation in the specified programming
     * language.
     *
    ...
    /**
     * Retrieves all documentation for a specific repository and programming
     * language.
     *
