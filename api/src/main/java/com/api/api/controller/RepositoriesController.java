...
/**
 * REST Controller for managing GitHub repositories. This controller handles
 * operations related to GitHub repositories including: - Fetching user's GitHub
 * repositories - Adding new repositories - Managing repository documentation -
 * Deleting repositories All endpoints require JWT authentication.
 */
@RestController
@RequestMapping("/api")
public class RepositoriesController {
     ...
     * @return ResponseEntity containing the decoded token claims or error
     * message
     */
     ...
     *
     * @param authHeader The Authorization header containing the JWT token
     * @return ResponseEntity containing the decrypted access token or error
     * message
     */
     ...
     *
     * @param authHeader The Authorization header containing the JWT token
     * @return ResponseEntity containing the list of repositories or error
     * message
     */
