...
/**
 * Represents a file from a repository that has been scanned and stored in the system.
 * This class is used to store the content of files from repositories for later analysis
 * and documentation. Files are stored in MongoDB in the 'repository_files' collection.
 */
@Data
