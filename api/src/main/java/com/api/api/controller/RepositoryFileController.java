...
/**
 * REST Controller for managing repository files. This controller handles operations
 * related to scanning and retrieving files from repositories. All endpoints require JWT
 * authentication.
 */
@RestController
@RequestMapping("/api")
public class RepositoryFileController {
	...
	/**
	 * Retrieves files from a repository, optionally filtered by programming language.
	 * @param authHeader The Authorization header containing the JWT token
