...
/**
 * Represents a user activity in the system. This class is used to track various
 * user actions and events. Activities are stored in MongoDB in the 'activities'
 * collection.
 */
