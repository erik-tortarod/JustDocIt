...
/**
 * Represents code documentation for a specific file in a repository. This class stores
 * structured documentation for code elements like classes, functions, interfaces, etc.
 * Documentation is stored in MongoDB in the 'code_documentation' collection.
 */
@Data
...
public class CodeDocumentation {
	...
	/**
	 * Represents the structured content of code documentation. Contains lists of
	 * different code elements that have been documented.
	 */
	@Data
