...
/**
 * Servicio para gestionar la documentación de código extraída de repositorios.
 * Coordina el escaneo de repositorios, extracción de documentación y
 * almacenamiento.
 */
@Service
public class CodeDocumentationService {
    ...
    public List<CodeDocumentation> scanRepositoryForDocumentation(String githubRepoId, Language language,
        ...
        if (branch == null) {
            try {
                ...
                ResponseEntity<Map> response = restTemplate.exchange(repoUrl, HttpMethod.GET, new HttpEntity<>(headers), Map.class);
    ...
    /**
     * Escanea un directorio recursivamente en busca de archivos del lenguaje
     * especificado
     */
    private void scanDirectory(String url, String repoId, Language language, String token,
        ...
        try {
            ...
            ResponseEntity<List> response = restTemplate.exchange(urlWithBranch, HttpMethod.GET, new HttpEntity<>(headers),
                    List.class);
            ...
            for (Map<String, Object> item : contents) {
                ...
                if ("dir".equals(type)) {
                    ...
                    if (fileContent != null) {
                        ...
                        logger.debug("First 100 chars: {}", fileContent.substring(0, Math.min(fileContent.length(), 100)));
    ...
    public List<CodeDocumentation> getRepositoryDocumentation(String repositoryId, Language language) {
        ...
        return documentationRepository.findByRepositoryIdAndLanguageAndBranch(repositoryId, language, repository.getBranch());
    }
    ...
    public CodeDocumentation getFileDocumentation(String repositoryId, String filePath) {
        ...
        return docs.stream()
                .filter(doc -> repository.getBranch().equals(doc.getBranch()))
                .findFirst()
                .orElse(null);
    }
    ...
    public List<CodeDocumentation> getRepositoryDocumentationByUser(String repositoryId, String userId,
        ...
        if (language != null) {
            ...
            logger.info("Buscando documentación para repositoryId: {}, userId: {}, branch: {}",
                    repositoryId, userId, repository.getBranch());
