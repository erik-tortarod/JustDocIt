...
public class PythonDocumentationParser {
	...
	public CodeDocumentation parseFile(String repositoryId, String filePath, String content, Language language) {
		...
		try {
			...
			while (functionMatcher.find()) {
				...
				codeFunction.setParameters(extractParameters(params));
	...
	private List<CodeMethod> extractMethods(String classBlock) {
		...
		while (methodMatcher.find()) {
			...
			codeMethod.setParameters(extractParameters(params));
	...
	private List<CodeParameter> extractParameters(String paramsString) {
		...
		for (String param : params) {
			...
			parameter.setDescription(null); // Python doesn't have parameter docstrings
