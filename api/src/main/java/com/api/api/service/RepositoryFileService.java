...
/**
 * Service class for managing repository files. This service handles operations
 * related to scanning repositories for files of specific programming languages,
 * retrieving file contents, and storing them in the database.
 */
@Service
public class RepositoryFileService {
    ...
    /**
     * Scans a repository for files of a specific programming language and
     * stores them.
     *
    ...
    /**
     * Recursively scans a directory in the repository for files of the
     * specified language.
     *
