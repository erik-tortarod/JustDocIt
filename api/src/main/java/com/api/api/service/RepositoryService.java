...
/**
 * Service class for managing GitHub repositories in the system. This service handles
 * operations related to saving, retrieving, and deleting repositories, as well as
 * managing their associated documentation.
 */
@Service
public class RepositoryService {
	...
	/**
	 * Saves a repository to the database. If a repository with the same GitHub ID and
	 * branch already exists for the user, it updates the existing repository instead of
	 * creating a new one.
