		...
		<section className="mx-auto py-20 px-4 w-screen ">
			...
			<div className="mt-32 text-center">
				...
				<p className="text-lg text-base-content/70 mb-10 max-w-2xl mx-auto">
					Únete a miles de desarrolladores que confían en JustDocIt para crear
					documentación profesional sin salir del navegador. Sin instalaciones,
					sin complicaciones.
				</p>
				<div className="flex gap-6 justify-center">
					<button className="btn btn-primary btn-lg">Comenzar gratis</button>
					<button className="btn btn-outline btn-lg">Ver planes Premium</button>
				</div>
			</div>
		</section>
	);
