...
function Documentation() {
   ...
   useEffect(() => {
      ...
      const addVisit = async () => {
         if (id) {
            const url = API_ROUTES.DOCS.ADD_VISIT.replace(
               "**repository_id**",
               id
            );
   ...
   // Función para cerrar el sidebar al hacer clic fuera
   ...
   return (
      <div className="flex min-h-screen bg-base-100 text-base-content w-screen">
         ...
         {/* Sidebar */}
         <aside
            className={`fixed lg:sticky top-0 left-0 h-screen bg-base-200 border-r border-base-300 overflow-y-auto transition-all duration-300 ease-in-out z-50
            ${
               isSidebarOpen
                  ? "translate-x-0"
               ...
               {activeSection === "files" && (
                  <div>
                     ...
                     {filteredFiles.length > 0 ? (
                        ...
                        <div className="text-center py-4 text-base-content/50">
                           No se encontraron archivos que coincidan con la
                           búsqueda
                        </div>
                     )}
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                     <div className="dropdown dropdown-end">
                        ...
                        >
                           ...
                           <li>
                              <a onClick={() => handleLanguageChange("python")}>
                                 Python
                              </a>
                           </li>
                           <li>
                              <a onClick={() => handleLanguageChange("php")}>
                                 PHP
                              </a>
                           </li>
                        </ul>
                     ...
                     <div className="card bg-base-200 p-6 mb-8 max-w-2xl mx-auto">
                        <div className="alert alert-warning">
                           <div>
                              ...
                              <span>
                                 No hay documentación disponible para {language}{" "}
                                 en este repositorio
                              </span>
                           </div>
                        </div>
                        ...
                        <div className="card bg-base-200 p-6 mb-8 max-w-2xl mx-auto">
                           ...
                           <div className="stats shadow">
                              ...
                              <div className="stat">
                                 ...
                                 <div className="stat-value">
                                    {currentFile.content?.functions?.length ||
                                       0}
                                 </div>
                              </div>
                              ...
                              <div className="stat">
                                 ...
                                 <div className="stat-value">
                                    {currentFile.content?.interfaces?.length ||
                                       0}
                                 </div>
                              </div>
                           </div>
                           ...
                           {!fileHasDocumentation(currentFile) && (
                              <div className="alert alert-warning mt-6">
                                 <div>
                                    ...
                                    <span>
                                       Este archivo no tiene documentación
