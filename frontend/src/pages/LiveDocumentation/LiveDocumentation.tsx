...
function LiveDocumentation() {
	...
	const [selectedPrompt, setSelectedPrompt] = useState<PromptType>("terraform");
	...
	const handleSubmit = async () => {
		...
		try {
			...
			const response = await fetch("http://localhost:11434/api/generate", {
				...
				body: JSON.stringify({
					model: "llama3",
					prompt: selectedPromptGenerator.generatePrompt(fileContents),
					stream: false,
					system: selectedPromptGenerator.systemPrompt,
				}),
			});
			...
			setDocumentation(data.response);
