						...
						{[
							{
								...
								title: t("documentation.guide.howToUse.steps.connect.title"),
								description: t(
							...
							},
							{
								...
								title: t("documentation.guide.howToUse.steps.select.title"),
								description: t(
							...
							},
							{
								...
								title: t("documentation.guide.howToUse.steps.learn.title"),
								description: t(
							...
							},
							{
								...
								title: t("documentation.guide.howToUse.steps.generate.title"),
								description: t(
				...
				content: (
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						{[
							...
							{
								title: t("documentation.guide.features.items.github.title"),
								description: t(
									"documentation.guide.features.items.github.description",
								),
							},
							{
								title: t("documentation.guide.features.items.realtime.title"),
								description: t(
